<template>
	<view class="main">
		<view class="main1">
			...
			<chatMsglist ref="chatMsglist" :username="username" :dataJob="dataJob" @msglistTap="normalScroll"
				@clickMsg="clickMsg" id="chat-msglist"></chatMsglist>
		</view>
		<chatInputbar ref="chatInputbar" :username="username" :chatType="chatType" @newTextMsg="saveSendMsg"
			...
			@tapSendAudio="toggleRecordModal" @makeVideoCall="onMakeVideoCall" @makeAudioCall="onMakeAudioCall"
