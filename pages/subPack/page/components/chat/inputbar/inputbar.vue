      ...
      <swiper-item>
        <view :class="'other_func ' + (isIPX ? 'other_func_X' : '')">
          <view class="open_camera" @tap="openCamera">
            <image src="/pages/subPack/page/static/chat/camora.png"></image>
            相机
          </view>
          <view class="menu_wrap" @tap="sendImage">
            <image src="/pages/subPack/page/static/chat/pic.png"></image>
            相册
          </view>
          <!-- #ifdef APP-PLUS -->
          <view class="menu_wrap">
            <chatSuitAttach :username="username" :chatType="chatType">
              <image
                ...
                src="/pages/subPack/page/static/chat/file.png"
              ></image>
              附件
            </chatSuitAttach>
          </view>
