...
<script>
	...
	let msgType = require("@/pages/subPack/page/components/chat/msgtype.js");
	...
	let msgStorage = require("@/pages/subPack/page/components/chat/msgstorage.js");
		...
		methods: {
			...
			handleRecording(e) {
				...
				if (sysInfo.uniPlatform === "web") {
					import("@/recorderCore/src/recorder-core.js").then((Recorder) => {
						require("@/recorderCore/src/engine/mp3.js");
						require("@/recorderCore/src/engine/mp3-engine.js");
