<template>
  ...
  <form class="text-input">
    <view :class="isIPX ?'f-row-x' :'f-row'">
      <!-- 发送语音 -->
      <view>
        <image class="icon-mic" src="/pages/subPack/page/static/chat/voice.png" @tap="openRecordModal"></image>
      </view>
     <view class="input_text">
      ...
      <view>
        <image class="icon-mic" src="/pages/subPack/page/static/chat/Emoji.png" @tap="openEmoji"></image>
      </view>
      <view v-show="!inputMessage" @tap="openFunModal">
        <image class="icon-mic" src="/pages/subPack/page/static/chat/ad.png"></image>
      </view>
       <button 
